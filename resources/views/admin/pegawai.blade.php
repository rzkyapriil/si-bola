...
<div id="tambah_modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
  ...
  <div class="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 mb-6">
		<h1 class="text-2xl font-bold w-fit md:w-full">Pegawai</h1>

		<div class="flex w-full">
			<form method="GET" action="{{route('pegawai.index')}}" class="w-full mx-auto">
				<div class="flex">
					<input type="search" name="cari" value="{{$cari}}" class="flex p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-s-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700 " placeholder="Cari nama jabatan" />
