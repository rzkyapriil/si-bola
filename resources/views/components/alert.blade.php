<div id="alert" class="absolute left-0 right-0 mx-auto mt-20 z-10 w-fit">
  ...
  @elseif(Session::get('alert') == 'success')
  ...
  @elseif(Session::get('alert') == 'warning')
